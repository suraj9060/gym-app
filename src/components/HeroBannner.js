...
const HeroBannner = () => {
  return (
      <Box sx={{
          ...
          <Typography fontWeight={700} sx={{fontSize:{lg:"44px" , sx:"40px"}}} mb="23px" mt={3}>Sweat, Smile <br />and Repeat</Typography>
          ...
          <Typography fontWeight={600}
              ...
              fontSize="200px"
          >Exercise</Typography>
          <img src={ HeroBannerImage} alt="gym Image" className="hero-banner-img"/>
      </Box>
  )
}
